...
Logic 2: Prepend donor before host module.
    donor function + host program -> injected program
...
OUTPUT_VALID_DIR = Path("directory/injected_programs/logic_2/valid")
OUTPUT_INVALID_DIR = Path("directory/injected_programs/logic_2/invalid")
...
def inject_donor(host_code: str, donor_code: str) -> str:
    ...
    # Prepend donor top-level nodes before host module
    host_tree.body = donor_tree.body + host_tree.body
